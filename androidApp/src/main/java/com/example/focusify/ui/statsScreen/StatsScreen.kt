...
package com.example.focusify.ui.statsScreen
...
import com.example.focusify.ui.Screen
import com.example.focusify.ui.calculatePaneScaffoldDirective
import com.example.focusify.ui.settingsScreen.DetailPlaceholder
import com.example.focusify.ui.statsScreen.screens.LastMonthScreen
import com.example.focusify.ui.statsScreen.screens.LastWeekScreen
import com.example.focusify.ui.statsScreen.screens.LastYearScreen
import com.example.focusify.ui.statsScreen.screens.StatsMainScreen
import com.example.focusify.ui.statsScreen.viewModel.StatsViewModel
import com.example.focusify.ui.theme.AppFonts.googleFlex400
...
fun StatsScreenRoot(
    ...
    val incompletedTodayCount by viewModel.incompletedTodayCount.collectAsStateWithLifecycle()
    val plannedTasksCount by viewModel.plannedTasksCount.collectAsStateWithLifecycle()
    val projectsCount by viewModel.projectsCount.collectAsStateWithLifecycle()
    val tagsCount by viewModel.tagsCount.collectAsStateWithLifecycle()
        ...
        NavDisplay(
            ...
            entryProvider = entryProvider {
                entry<Screen.Stats.Main>(
                    ...
                    this@SharedTransitionLayout.StatsMainScreen(
                        goal = focusGoal,
                        ...
                        incompletedCount = incompletedTodayCount,
                        plannedCount = plannedTasksCount,
